...
{
    public class BLL_JAVA11 : ITemplate
    {
        ...
        public IReturnCode[] GetCode()
        {
            ...
            sb.AppendLine("/**");
            sb.AppendLine(" * " + Tbl.TableName + " 业务逻辑接口");
            sb.AppendLine(" * 文件说明: " + Tbl.TableDescription + "接口");
            sb.AppendLine(" * 作    者: " + this.OperName);
            sb.AppendLine(" * 生成日期: " + DateTime.Now.ToString("yyyy年MM月dd日"));
            sb.AppendLine(" * 生成模板: Esint.Template.Service.JAVA_Service 版");
            sb.AppendLine(" * 修改说明：");
            sb.AppendLine(" */");
