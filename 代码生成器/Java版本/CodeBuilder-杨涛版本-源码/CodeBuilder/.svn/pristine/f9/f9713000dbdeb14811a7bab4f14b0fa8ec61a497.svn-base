...
namespace Esint.Template.Model
{
    ...
    /// 模板生成页
    /// </summary>
    public partial class Ef_Model : Form, ITemplate
    {
        ...
        public IReturnCode[] GetCode()
        {
            ...
            returnCode[0].FileName = String.Format(FileName + "Map.cs", Tbl.PascalName);
        ...
        private StringBuilder CreateModelDesigner()
        {
            ...
            sb.AppendLine("        }");
            sb.AppendLine("");
        //   sb.AppendLine("        public System.Guid UserID { get; set; }");
        //    sb.AppendLine("        public Nullable<System.Guid> DepartmentID { get; set; }");
