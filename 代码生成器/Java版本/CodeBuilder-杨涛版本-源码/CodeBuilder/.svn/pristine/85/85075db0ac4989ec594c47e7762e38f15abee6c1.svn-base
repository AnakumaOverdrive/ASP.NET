...
namespace Esint.Template.BLL
{
    public class BLL_11 : ITemplate
    {
        ...
        public IReturnCode[] GetCode()
        {
            ...
            sb.AppendLine("using Esint." + DataAccess.AppName + ".Factory;");
            ...
            sb.AppendLine("    /// 模板版本: Esint.Template.BLL.BLL_11 版，适用于反射工厂模式开发!");
            ...
            sb.AppendLine("        private I" + Tbl.PascalName + "Data dataAccess = Factory.Factory.Create" + Tbl.PascalName + "Data();");
            ...
            sb1.AppendLine("using Esint." + DataAccess.AppName + ".Factory;");
            sb1.AppendLine("using Esint." + DataAccess.AppName + ".IDAL;");
