...
namespace Esint.CodeBuilder.MySqlData.DAL
{
    public class MySqlDataAccess
    {
        ...
        public string GetSysDate()
        {
            ...
            try
            {
                string strSql = "Select sysdate() AS DBDATE";
                using (IDataReader dr = Microsoft.ApplicationBlocks.Data.MySqlHelper.ExecuteReader((MySqlConnection)conn, CommandType.Text, strSql.ToString()))
                {
                    if (dr.Read())
                    {
        ...
        public MySqlDataReader ExecuteReader(IDbConnection conn, CommandType commandType, string SQL)
        {
            return Microsoft.ApplicationBlocks.Data.MySqlHelper.ExecuteReader((MySqlConnection)conn, commandType, SQL);
        }
    }
}
