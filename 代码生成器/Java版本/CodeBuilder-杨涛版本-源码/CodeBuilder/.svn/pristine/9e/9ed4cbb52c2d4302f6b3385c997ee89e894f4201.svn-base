...
{
    public class OracleDAL_01:ITemplate
    {
        ...
        {  
            ...
            sb.AppendLine("    /// 生成模板: Esint.Template.OracleDAL.OracleDAL_01 版");
        ...
        private bool IsAllowColLength(string colType)
        {
            ...
            string[] types = new string[]{
              "DateTime?","DateTime","byte[]","int","int?","long","double","double?"
            };
